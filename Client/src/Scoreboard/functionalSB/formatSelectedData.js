export const formatSelectedData = function(selectedGameData) {
    ...
    if (selectedGameData.league === 'NFL' && selectedGameData.awayName === "undefined") {
        selectedGameData.awayName = "Football Team";
    }
    if (selectedGameData.league === 'NFL' && selectedGameData.homeName === "undefined") {
        selectedGameData.homeName = "Football Team";
    }
